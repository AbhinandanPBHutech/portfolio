        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="E-commerce"
              description="Developed a dynamic e-commerce platform using HTML , CSS and js for efficient client-side
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={editor}
              isBlog={false}
              title="Ed-tech Portal"
              description="Familiarity with popular UI libraries and frameworks: Knowledge of
              Building and optimizing responsive and interactive product catalogs, cart, and checkout
